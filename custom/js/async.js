...
function onMediaQueryChange() {
  ...
  var elementPosition = position.getBoundingClientRect().top + window.pageYOffset - header - 10;
    ...
    cboxfe.addEventListener('click', function () {
      ...
      if (mediaQueryList.matches === true) {
        ...
        if (frontpage === true) {
          ...
          var _elementPosition2 = position.getBoundingClientRect().top + window.pageYOffset - header - 100;

          window.scrollTo({
            top: _elementPosition2,
            behavior: "smooth"
          });
        }
      }
